...
class OrderItemTest {
    ...
    void create_order_fail_when_memberId_is_null() {
        ...
        assertThat(coreException.getCustomMessage()).isEqualTo("잘못된 주문입니다..");
    }
    ...
    void create_order_fail_when_productId_is_null() {
        CoreException coreException
                = assertThrows(CoreException.class, () -> OrderItem.create(OrderFixture.createOrder(), null, 1L, BigDecimal.ONE));
    ...
    void create_order_fail_when_quantity_is_invalid() {
        CoreException coreException
                = assertThrows(CoreException.class, () -> OrderItem.create(OrderFixture.createOrder(), 1L, -1L, BigDecimal.ONE));
    ...
    void create_order_fail_when_quantity_is_null() {
        CoreException coreException
                = assertThrows(CoreException.class, () -> OrderItem.create(OrderFixture.createOrder(), 1L, null, BigDecimal.ONE));
    ...
    void create_order_fail_when_price_is_invalid() {
        CoreException coreException
                = assertThrows(CoreException.class, () -> OrderItem.create(OrderFixture.createOrder(), 1L, 1L, BigDecimal.valueOf(-1)));
    ...
    void create_order_fail_when_price_is_null() {
        CoreException coreException
                = assertThrows(CoreException.class, () -> OrderItem.create(OrderFixture.createOrder(), 1L, 1L, null));
    ...
    void create_order_test() {
        OrderItem orderItem = OrderItem.create(OrderFixture.createOrder(), 1L, 1L, BigDecimal.ONE);
